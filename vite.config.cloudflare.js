...
import { remarkImageOptimization } from './src/blog/utils/remark-image-optimization.js';
...
export default defineConfig(({ command, mode }) => {
  ...
  // Note: vite-imagetools is excluded for Cloudflare Pages due to sharp dependency
